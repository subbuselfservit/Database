			  ...
			  '"call_status":"'+  a.call_status+'",'+
			   ...
			   +'",'+	
				...
				'"billable_nonbillable_ind_desc":"'+
					ISNULL((''), '')
				+'",'+
				'"won_lost_ind":"'+cast(ISNULL(won_lost_indicator,0) as varchar(1))+'",'+
				...
				'"proforma_ref_no":"'+isnull(a.proforma_ref_no,'')+'",'+
			    '"proforma_ref_date":"'+isnull(CONVERT(varchar(10),a.proforma_ref_date,120),'')+'",'+
			    '"proforma_gross_amount":"'+cast(ISNULL(proforma_gross_amount,0) as varchar(15))+'",'+
			    '"proforma_net_amount":"'+cast(ISNULL(proforma_net_amount,0) as varchar(15))+'",'+
			    '"proforma_discount_amount":"'+cast(ISNULL(proforma_discount_amount,0) as varchar(15))+'",'+
			    '"proforma_tax_amount":"'+cast(ISNULL(proforma_tax_amount,0) as varchar(15))+'",'+
			    '"charges_ref_no":"'+isnull(a.charges_ref_no,'')+'",'+
			    '"charges_ref_date":"'+isnull(CONVERT(varchar(10),a.charges_ref_date,120),'')+'",'+
			   ...
			   '"service_contract_doc_desc":"'+
				...
				+'",'+
			   '"product_udf_char_1":"'+ISNULL(a.product_udf_char_1,'')+'",'+
			   '"product_udf_char_2":"'+ISNULL(a.product_udf_char_2,'')+'",'+
			   '"product_udf_char_3":"'+ISNULL(a.product_udf_char_3,'')+'",'+
			   '"product_udf_char_4":"'+ISNULL(a.product_udf_char_4,'')+'",'+
			   '"product_udf_bit_1":"'+cast(ISNULL(a.product_udf_bit_1,0) as varchar(1))+'",'+
			   '"product_udf_bit_2":"'+cast(ISNULL(a.product_udf_bit_2,0) as varchar(1))+'",'+
			   '"product_udf_float_1":"'+cast(ISNULL(a.product_udf_float_1,0) as varchar(14))+'",'+
			   '"product_udf_float_2":"'+cast(ISNULL(a.product_udf_float_2,0) as varchar(14))+'",'+
			   '"product_udf_date_1":"'+isnull(convert(varchar(10), a.product_udf_date_1, 120),'')+'",'+
			   '"product_udf_date_1_hour":"'+isnull(substring(CONVERT(varchar(10), a.product_udf_date_1, 108),1,2),'')+'",'+
			   '"product_udf_date_1_minute":"'+isnull(substring(CONVERT(varchar(10), a.product_udf_date_1, 108),4,2),'')+'",'+
			   '"product_udf_date_2":"'+isnull(convert(varchar(10), a.product_udf_date_2, 120),'')+'",'+
			   '"product_udf_date_2_hour":"'+isnull(substring(CONVERT(varchar(10), a.product_udf_date_2, 108),1,2),'')+'",'+
			   '"product_udf_date_2_minute":"'+isnull(substring(CONVERT(varchar(10), a.product_udf_date_2, 108),4,2),'')+'",'+
			   '"product_udf_analysis_code1":"'+isnull(a.product_udf_analysis_code1,'')+'",'+
			   '"product_udf_analysis_code2":"'+isnull(a.product_udf_analysis_code2,'')+'",'+
			   '"product_udf_analysis_code3":"'+isnull(a.product_udf_analysis_code3,'')+'",'+
			   '"product_udf_analysis_code4":"'+isnull(a.product_udf_analysis_code4,'')+'",'+
