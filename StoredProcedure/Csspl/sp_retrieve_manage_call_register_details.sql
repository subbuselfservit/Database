   ...
   */
	...
	select a.call_ref_no, a.asset_id, a.call_status,  a.closed_on_date,
			...
			'"call_wf_stage":"'+
			   ...
			   '"udf_float_1":"'+cast(ISNULL(a.udf_float_1,0) as varchar(14))+'",'+
			   '"udf_float_2":"'+cast(ISNULL(a.udf_float_2,0) as varchar(14))+'",'+
			   '"udf_float_3":"'+cast(ISNULL(a.udf_float_3,0) as varchar(14))+'",'+
			   '"udf_float_4":"'+cast(ISNULL(a.udf_float_4,0) as varchar(14))+'",'+
